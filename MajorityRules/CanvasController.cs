...
namespace SurfaceApplication1
{
    ...
    public class CanvasController
    {
        ...
        public CanvasController(Canvas MainCanvas, int width, int height, TextBlock debugText)
        {
            ...
            addButtonBall = new ButtonBall(new Vector(random.Next(151, 800), random.Next(0, 600)), new Vector(random.Next(2, 5), random.Next(2, 5)), this._mainCanvas, 50, Color.FromArgb(255, 0, 0, 0), this, "Add new Idea");
            gravityButtonBall = new GravityBall(new Vector(random.Next(151, 800), random.Next(0, 600)), new Vector(random.Next(2, 5), random.Next(2, 5)), this._mainCanvas, 50, Color.FromArgb(100, 0, 0, 0), this, "Add new Idea");
